...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   dataloader->AddVariable("Wjetmsoftdrop",'F');
   dataloader->AddVariable("Wjettau21",'F');
   dataloader->AddVariable("Wjettau32",'F');
   dataloader->AddVariable("Wjettau1",'F');
   dataloader->AddVariable("Wjettau2",'F');
   dataloader->AddVariable("Wjettau3",'F');
   dataloader->AddVariable("WjetPt",'F');
...
//   dataloader->AddVariable("VBSPtjj",'F');
   ...
   factory->BookMethod(dataloader, TMVA::Types::kBDT, "BDT",
           "!H:!V:MaxDepth=Change_MAXDEEPTH:Ntrees=Change_NTREES:BoostType=RealAdaBoost:SeparationType=CrossEntropy:nCuts=-1:NodePurityLimit=0.95");
