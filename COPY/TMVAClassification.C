...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   TTree *signalTreeTrain  = (TTree*)siginput->Get("trainEvents");
   TTree *backgroundTrain  = (TTree*)bkginput->Get("trainEvents");
   TTree *signalTreeTest   = (TTree*)siginput->Get("testEvents");
   TTree *backgroundTest   = (TTree*)bkginput->Get("testEvents");
   ...
   //
   dataloader->AddVariable("Hbbscore",'F');
   dataloader->AddVariable("Hbbmass",'F');
//   dataloader->AddVariable("Hbbmsoftdrop",'F');
//   dataloader->AddVariable("Hbbtau21",'F');
//   dataloader->AddVariable("Hbbtau32",'F');
//   dataloader->AddVariable("Hbbtau1",'F');
//   dataloader->AddVariable("Hbbtau2",'F');
//   dataloader->AddVariable("Hbbtau3",'F');
//   dataloader->AddVariable("HbbPt",'F');

   dataloader->AddVariable("Wjetscore",'F');
   dataloader->AddVariable("Wjetmass",'F');
   dataloader->AddVariable("Wjettau2",'F');
//   dataloader->AddVariable("Zjetscore",'F');
//   dataloader->AddVariable("Zjetmass",'F');
//   dataloader->AddVariable("Zjetmsoftdrop",'F');
   //dataloader->AddVariable("Zjettau21",'F');
   //dataloader->AddVariable("Zjettau32",'F');
//   dataloader->AddVariable("Zjettau1",'F');
//   dataloader->AddVariable("Zjettau2",'F');
//   dataloader->AddVariable("Zjettau3",'F');
//   dataloader->AddVariable("ZjetPt",'F');

//   dataloader->AddVariable("leptonpt",'F');
//   dataloader->AddVariable("VBSMjj",'F');
//   dataloader->AddVariable("VBSdetajj",'F');
//   dataloader->AddVariable("VBSPtjj",'F');
...
//   dataloader->AddVariable("MET",'F');
   ...
   TCut mycuts = "trans_E < 4000 && trans_E > 1000 && Wjetscore > 0.9";// && Zjetscore > 0.9"; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "trans_E < 4000 && trans_E > 1000 && Wjetscore > 0.9";// && Zjetscore > 0.9"; // for example: TCut mycutb = "abs(var1)<0.5";
   ...
   factory->BookMethod(dataloader, TMVA::Types::kBDT, "BDT",
           "!H:!V:MaxDepth=4:Ntrees=30:BoostType=RealAdaBoost:SeparationType=CrossEntropy:nCuts=-1:NodePurityLimit=0.95");
